...
const char* ssid     = "Friends4";
const char* password = "TheWillowTree";

// ThingSpeak
unsigned long channelID = 606574;
const char* writeAPIKey = "CBAJMWQXTJIW4ZPN";
...
// Reset Heltec Screen
 ...
 // Line 61 of SSD1306AsciiWire.h was remmed out i.e. //#warning set400kHz() disabled for this CPU
